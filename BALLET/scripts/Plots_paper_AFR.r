...
#beta
readRDS('/mnt/sequencedb/PopGen/barbara/NCV_dir_package/BETA/tmp/Power_Tbs5_beta.Rds')-> beta.Tbs5
readRDS('/mnt/sequencedb/PopGen/barbara/NCV_dir_package/BETA/tmp/tbs3/Power_Tbs3_beta.Rds')-> beta.Tbs3
...
#PATH3='/mnt/sequencedb/PopGen/barbara/NCV_dir_package/BALLET/tmp_Eur/'
...
dev.off()
#
pdf('ROCS_for_paper/v3_ROC_all_stats_AFR_3000bp_Tbs5_feq0.5.pdf')
...
legend('bottomright', c('NCD2', 'BETA','T2','T1','TajD', 'HKA'),col=c('cornflowerblue','steelblue','red4','red4','seagreen','plum4'), lty=c(1,2,1,2,2,2), lwd=c(4,2,2,2,2,2), bty='n',pch=c(19,19,19,19,19,19), xpd=F, horiz=F, cex=1.3)
...
lines(x=beta.Tbs5[['W_3kb']][['AFR']][, 'FPR'], y= beta.Tbs5[['W_3kb']][['AFR']][,'TPR.AFR.beta.f0.5'], col='steelblue', lty=2, lwd=2)
title(main="", sub="", xlab="FPR", ylab="TPR", cex.lab=1.5)
dev.off()
...
lines(x=Results.ROC.N_feq0.4_100[['Tbs5']][['bp3000']][['fEq0.4']][['taj.ROC']][, 'FPR'], y= Results.ROC.N100[['Tbs5']][['bp3000']][['fEq0.4']][['taj.ROC']][, 'AFR_5s'], lwd=2, col='seagreen', lty=2)
lines(x=Results.ROC.N_feq0.4_100[['Tbs5']][['bp3000']][['fEq0.4']][['hka.ROC']][, 'FPR'], y= Results.ROC.N100[['Tbs5']][['bp3000']][['fEq0.4']][['hka.ROC']][, 'AFR_5s'], lwd=2, col='plum4', lty=2)
legend('bottomright', c('NCD2', 'NCD1', 'NCD1+HKA','T2','T1','TajD', 'HKA'),col=c('cornflowerblue','darkblue','steelblue','red4','red4','seagreen','plum4'), lty=c(1,1,2,1,2,2,2), lwd=c(4,2,2,2,2,2,2), bty='n',pch=c(19,19,19,19,19,19,19), xpd=F, horiz=F, cex=1.3)
...
plot(x=Results.ROC.N_feq0.4_100[['Tbs5']][['bp3000']][['fEq0.4']]$ncvFD.ROC[,'FPR'],y=Results.ROC.N_feq0.4_100[['Tbs5']][['bp3000']][['fEq0.4']]$ncvFD[,'EUR_5s'],col='cornflowerblue', lwd=3, lty=1, xlim=c(0, 0.05), ylim=c(0,1), type='l', ylab="", xlab="", bty='l')
lines(x=Results.ROC.N_feq0.4_100[['Tbs5']][['bp3000']][['fEq0.4']]$ncv.ROC[,'FPR'], y=Results.ROC.N_feq0.4_100[['Tbs5']][['bp3000']][['fEq0.4']]$ncv.ROC[,'EUR_5s'], lty=1, lwd=2, col='darkblue')
...
lines(x=Results.ROC.N_feq0.4_100[['Tbs5']][['bp3000']][['fEq0.4']][['hka.ROC']][, 'FPR'], y= Results.ROC.N_feq0.4_100[['Tbs5']][['bp3000']][['fEq0.4']][['hka.ROC']][, 'EUR_5s'], lwd=2, col='plum4', lty=2)

legend('bottomright', c('NCD2', 'NCD1', 'NCD1+HKA','T2','T1','TajD', 'HKA'),col=c('cornflowerblue','darkblue','steelblue','red4','red4','seagreen','plum4'), lty=c(1,1,2,1,2,2,2), lwd=c(4,2,2,2,2,2,2), bty='n',pch=c(19,19,19,19,19,19,19), xpd=F, horiz=F, cex=1.3)

lines(x=Results.ROC.N_feq0.4_100[["Tbs5"]][["bp3000"]][["fEq0.4"]][["ncv_hka.ROC"]][,'FPR.EUR_5s'], y=Results.ROC.N_feq0.4_100[["Tbs5"]][["bp3000"]][["fEq0.4"]][["ncv_hka.ROC"]][,'EUR_5s'], col='steelblue', lty=2, lwd=2)
...
lines(x=Results.ROC.N_feq0.3_100[['Tbs5']][['bp3000']][['fEq0.3']][['taj.ROC']][, 'FPR'], y= Results.ROC.N_feq0.3_100[['Tbs5']][['bp3000']][['fEq0.3']][['taj.ROC']][, 'AFR_5s'], lwd=2, col='seagreen', lty=2)
lines(x=Results.ROC.N_feq0.3_100[['Tbs5']][['bp3000']][['fEq0.3']][['hka.ROC']][, 'FPR'], y= Results.ROC.N_feq0.3_100[['Tbs5']][['bp3000']][['fEq0.3']][['hka.ROC']][, 'AFR_5s'], lwd=2, col='plum4', lty=2)
legend('bottomright', c('NCD2', 'NCD1', 'NCD1+HKA','T2','T1','TajD', 'HKA'),col=c('cornflowerblue','darkblue','steelblue','red4','red4','seagreen','plum4'), lty=c(1,1,2,1,2,2,2), lwd=c(4,2,2,2,2,2,2), bty='n',pch=c(19,19,19,19,19,19,19), xpd=F, horiz=F, cex=1.3)
...
lines(x=Results.ROC.N_feq0.3_100[['Tbs5']][['bp3000']][['fEq0.3']][['taj.ROC']][, 'FPR'], y= Results.ROC.N_feq0.3_100[['Tbs5']][['bp3000']][['fEq0.3']][['taj.ROC']][, 'EUR_5s'], lwd=2, col='seagreen', lty=2)
lines(x=Results.ROC.N_feq0.3_100[['Tbs5']][['bp3000']][['fEq0.3']][['hka.ROC']][, 'FPR'], y= Results.ROC.N_feq0.3_100[['Tbs5']][['bp3000']][['fEq0.3']][['hka.ROC']][, 'EUR_5s'], lwd=2, col='plum4', lty=2)

lines(x=Results.ROC.N_feq0.3_100[["Tbs5"]][["bp3000"]][["fEq0.3"]][["ncv_hka.ROC"]][,'FPR.EUR_5s'], y=Results.ROC.N_feq0.3_100[["Tbs5"]][["bp3000"]][["fEq0.3"]][["ncv_hka.ROC"]][,'EUR_5s'], col='steelblue', lty=2, lwd=2)
legend('bottomright', c('NCD2', 'NCD1', 'NCD1+HKA','T2','T1','TajD', 'HKA'),col=c('cornflowerblue','darkblue','steelblue','red4','red4','seagreen','plum4'), lty=c(1,1,2,1,2,2,2), lwd=c(4,2,2,2,2,2,2), bty='n',pch=c(19,19,19,19,19,19,19), xpd=F, horiz=F, cex=1.3)
