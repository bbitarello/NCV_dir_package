...
setwd("/mnt/sequencedb/PopGen/barbara/simulations/clone_cee_sims/testf0.3/")
gc()
library(parallel)
...
### Concatenating as a list the ROC curves for different tests
	...
	gc()
  assign(paste("Results.ROC.N_feq0.3_",popN[n],sep=""),res.tbs)
  ...
  save.image("Results.all.ROC1_feq0.3.RData"); cat("N chrom",popN[n],"done\n")
}
